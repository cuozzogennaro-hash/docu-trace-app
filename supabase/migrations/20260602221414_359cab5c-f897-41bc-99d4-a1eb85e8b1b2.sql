...
CREATE INDEX IF NOT EXISTS idx_non_conformities_asset_open
  ON public.non_conformities (user_id, asset_id) WHERE status = 'open';

-- operator_tasks: esclude assets con NC aperta
...
-- operator_period_status: stessa esclusione
...
-- admin_overdue_tasks: non segnalare ritardi su macchinari con NC aperta
