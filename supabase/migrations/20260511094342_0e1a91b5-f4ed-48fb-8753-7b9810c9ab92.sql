...
BEGIN
  ...
  WHERE id = (v_prod->>'department_id')::uuid AND user_id = v_op.user_id;
  ...
  RETURN jsonb_build_object('ok',true,'product',v_prod,'ingredients',v_ingredients,'label_templates',v_templates,'admin_user_id',v_op.user_id,'department_name',v_dept);
END; $function$;