    ...
    <>
      ...
      <Tabs defaultValue={initial} className="w-full" onValueChange={(v) => { sp.set("tab", v); setSp(sp, { replace: true }); }}>
        <TabsList className="flex flex-wrap h-auto gap-1 w-full max-w-4xl mb-6">
          ...
          <TabsTrigger value="profile" className="gap-1.5 text-xs sm:text-sm flex-1 min-w-[calc(33%-4px)] sm:min-w-0"><Briefcase size={14} className="hidden sm:inline" /> Profilo</TabsTrigger>
