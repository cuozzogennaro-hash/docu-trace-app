...
export default function ConsulenteDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-surface">
      <header className="sticky top-0 z-30 bg-card/90 backdrop-blur border-b border-border px-4 py-3 flex items-center justify-between shadow-soft">
        <div className="flex items-center gap-3">
          <img src={logoShield} alt="HACCP Trace" className="h-8 w-8 rounded-lg object-contain bg-white" />
          <span className="font-display font-bold text-sm sm:text-base">HACCP Trace — Area Partner</span>
        </div>
        <div className="flex items-center gap-3">
          {user?.email && (
